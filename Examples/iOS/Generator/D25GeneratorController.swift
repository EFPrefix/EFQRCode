...
#if os(iOS)
// MARK: - EFColorPicker
extension D25GeneratorController: UIColorPickerViewControllerDelegate {
    ...
    func customColor(_ index: Int) {
        ...
        colorPicker.selectedColor = [topColor, leftColor, rightColor, iconBorderColor, backdropColor][index]
