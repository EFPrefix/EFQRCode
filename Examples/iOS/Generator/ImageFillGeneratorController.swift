...
#if os(iOS)
// MARK: - EFColorPicker
extension ImageFillGeneratorController: UIColorPickerViewControllerDelegate {
    ...
    func customColor(_ index: Int) {
        ...
        colorPicker.selectedColor = [backgroundColor, maskColor, iconBorderColor, backdropColor][index]
