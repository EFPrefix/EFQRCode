//
//  RandomRectangleGeneratorController.swift
//  iOS Example
//
...
class RandomRectangleGeneratorController: UIViewController, UITextViewDelegate, UITableViewDelegate, UITableViewDataSource, UINavigationControllerDelegate {
...
extension RandomRectangleGeneratorController {
    ...
    override func viewDidLoad() {
        ...
        title = NSLocalizedString("Create RandomRectangle", comment: "Title on generator")
...
#if os(iOS)
// MARK: - EFColorPicker
extension RandomRectangleGeneratorController: UIColorPickerViewControllerDelegate {
...
#if os(iOS)
extension RandomRectangleGeneratorController: UIImagePickerControllerDelegate {
