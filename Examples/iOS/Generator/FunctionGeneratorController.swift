//
//  FunctionGeneratorController.swift
//  iOS Example
//
...
extension FunctionGeneratorController {
    ...
    override func viewDidLoad() {
        ...
        title = NSLocalizedString("Create Function", comment: "Title on generator")
    ...
    func chooseDataStyle() {
        chooseFromEnum(title: Localized.Title.dataStyle, type: EFStyleFunctionParamsDataStyle.self) { [weak self] result in
            guard let self = self else { return }
...
#if os(iOS)
// MARK: - EFColorPicker
extension FunctionGeneratorController: UIColorPickerViewControllerDelegate {
    ...
    func customColor(_ index: Int) {
        ...
        colorPicker.selectedColor = [dataColor, circleColor, positionColor, iconBorderColor, backdropColor][index]
...
#if os(iOS)
extension FunctionGeneratorController: UIImagePickerControllerDelegate {
