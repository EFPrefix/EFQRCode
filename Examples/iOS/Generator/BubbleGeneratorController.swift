//
//  BubbleGeneratorController.swift
//  iOS Example
//
...
class BubbleGeneratorController: UIViewController, UITextViewDelegate, UITableViewDelegate, UITableViewDataSource, UINavigationControllerDelegate {
...
extension BubbleGeneratorController {
    ...
    override func viewDidLoad() {
        ...
        title = NSLocalizedString("Create Bubble", comment: "Title on generator")
...
#if os(iOS)
extension BubbleGeneratorController: UIImagePickerControllerDelegate {
